...
class BST_Node
{
  ...
  public:
        ...
        BST_Node* left() const {return _left;} // Accessor
        BST_Node* &left() {return _left;} // Modifier
        
        BST_Node* right() const {return _right;} // Accessor
        BST_Node* &right() {return _right;} // Modifier
};
